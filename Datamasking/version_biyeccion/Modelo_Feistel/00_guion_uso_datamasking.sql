...
-- NOTA OPERATIVA SOBRE PEPPER DE SEGURIDAD:
-- El pepper aleatorio hace que cada instalación genere un pepper distinto, por lo
-- que los valores enmascarados difieren entre entornos. Si se necesita reproducir
-- exactamente un dump ya entregado (o que PRE coincida con otro entorno), generar
-- el pepper una sola vez y replicar la misma fila de la tabla tdm_secreto al resto
-- de entornos — nunca regenerarlo. Cambiar el pepper invalida la reproducibilidad.
