...
Report the redo log switches on an hourly basis from the all the instances on RAC Database
Report the size of the archive logs generated on daily basis from all the instances on RAC Database
