...
SELECT DB_NAME, HOSTNAME, Last_Sequence_Received, Last_Sequence_Applied,APPLIED_TIME,
Last_Sequence_Received-Last_Sequence_Applied LOG_GAP
FROM
(
SELECT NAME DB_NAME
FROM V$DATABASE
...
(
SELECT ARCH.THREAD# "Thread", ARCH.SEQUENCE# Last_Sequence_Received, APPL.SEQUENCE# Last_Sequence_Applied
